...
public class LoginController extends BaseController {
	...
	//viewGuide - creates a new guide controller and sets it as the active content pane.
	
	public void viewGuide() {
		GuideController gc = new GuideController();
		gc.setFrame(theFrame);
		gc.setPreviousPanel((BasePanel) theFrame.getContentPane());
		GuidePanel gp = new GuidePanel(gc);
		theFrame.setContentPane(gp);
		theFrame.pack();
	}
