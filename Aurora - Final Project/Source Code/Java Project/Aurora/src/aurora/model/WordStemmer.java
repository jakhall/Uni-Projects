...
public class WordStemmer {
	...
	//porter2 - Processes the string, following the rules of porter stemming.
	...
	//porter3 - Processes the string, following the rules of porter stemming.
	...
	//porter4 - Processes the string, following the rules of porter stemming.
	...
	//porter5a - Processes the string, following the rules of porter stemming.
	...
	//porter5b - Processes the string, following the rules of porter stemming.
