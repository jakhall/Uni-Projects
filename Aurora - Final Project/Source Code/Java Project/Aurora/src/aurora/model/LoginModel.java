...
public class LoginModel extends BaseModel {
	...
	//validateLogin - Returns the user with the input username and password. 
	//if the user exists then will initiate login with that user.
	...
	//Login - Adds the associated users to the profile being logged in,
