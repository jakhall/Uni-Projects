...
public class RegisterInvoker extends BaseInvoker {
		...
		public void setDetails(String t, String a, String f, String l, String e) {
		...
		public void createUser(Profile u) {
			...
			newUser.setDetails(u.getTitle(), u.getDOB(), u.getFirstName(), u.getLastName());
		}
		
		
		public boolean usernameTaken(String username) {
			return theModel.usernameTaken(username);
		}
		...
		public byte[] getDefaultImage() {
			...
			try {
				return IOUtils.toByteArray(ProfileDatabase.class.getResourceAsStream("/default_data/profile_image/default_" + newUser.getDefaultColor() + ".png"));
		...
		public Response handleRequest(Request request) {
			...
			case 5 : byte[] bytes = (byte[]) request.getObject();
					 ...
					 break;
			case 6 : String username = (String) request.getObject();
					 response.setSwitch(usernameTaken(username));
					 break;
				}
