...
public class GuidePanel extends BasePanel {
	...
	protected void setupPanel() {
		...
		baseLayout.putConstraint(SpringLayout.SOUTH, lblAuroraIs, -24, SpringLayout.NORTH, lblConnectTo);
		...
		baseLayout.putConstraint(SpringLayout.WEST, lblConnectTo, 0, SpringLayout.WEST, lblAuroraWill);
		baseLayout.putConstraint(SpringLayout.SOUTH, lblConnectTo, -26, SpringLayout.NORTH, lblAuroraWill);
		...
		baseLayout.putConstraint(SpringLayout.NORTH, lblRegisterToday, 30, SpringLayout.SOUTH, lblOpenYour);
		baseLayout.putConstraint(SpringLayout.WEST, lblRegisterToday, 0, SpringLayout.WEST, lblAuroraWill);
