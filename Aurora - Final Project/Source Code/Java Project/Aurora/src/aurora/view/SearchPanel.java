...
public class SearchPanel extends MainPanel {
	...
	protected void setupPanel() {
		...
		springLayout.putConstraint(SpringLayout.WEST, queryCombo, 215, SpringLayout.EAST, lblResults);
		...
		queryCombo.setModel(new DefaultComboBoxModel(new String[] {"Users", "Documents"}));
	...
	public void updateResults() {
		if(theController.getIsProfile()) {
			resultList.setListData(theController.getResultsUsername());
		} else {
			resultList.setListData(theController.getResultDocuments());
		}
	...
	protected void setupListeners() {
		...
		btnView.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent click) {
				theController.viewItem(resultList.getSelectedIndex());
			}
		});	
		...
		queryCombo.addActionListener (new ActionListener () {
		    public void actionPerformed(ActionEvent e) {
		    	...
		    	} else if(queryCombo.getSelectedIndex() == 1) {
